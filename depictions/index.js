...
$(document).ready(function () {
    ...
    if (!dPackage) {
        $(".package-error").text("Phân tích tương thích chỉ hoạt động khi Tinh chỉnh đã được cài!").css("display", "block");
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        for (var i = 0; i < changes.length - 1; i++) {
            cList.append("<div style=\"border-bottom:0px solid #dad8d8;margin-left:-10px;margin-right:-10px;padding-bottom:7px;margin-bottom:7px;\">" + "<div style=\"margin-left:15px;margin-right:15px\">" + changes[i] + "</div>" + "</div>")
        }
        ...
        for (var v in versions) {
            ...
            for (var i = 0; i < changes.length - 1; i++) {
                ...
                panel.find(".changelog-list").append("<div style=\"border-bottom:0px solid #dad8d8;margin-left:-10px;margin-right:-10px;padding-bottom:7px;margin-bottom:7px;\">" + "<div style=\"margin-left:15px;margin-right:15px\">" + change + "</div>" + "</div>");
            }
        ...
        var extra = {
            ...
            "<img class=\"icon\" src=\"icons/email.png\"><span>Send me an email</span>": "mailto:kt.contact.ads@gmail.com",
            "<img class=\"icon\" src=\"icons/like.png\"><span>Buy me a &#x1F37A; via <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://paypal.me/kimtrong"
        };
        $.extend(links, extra);
